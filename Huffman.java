...
public class Huffman {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File file = new File("aliceenglish.txt");
        ...
        File file1 = new File("aliceenglish.txt");
        ...
        File fileOfBytes = new File("aliceenglishcompressed.bin");
        ...
        try {
            ...
            FileInputStream fis = new FileInputStream("aliceenglishcompressed.bin");
            FileOutputStream fis1 = new FileOutputStream(new File("aliceenglishdecompressed.txt"));
        ...
        try {
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("huffmantreealiceenglish.ser"));
